...
public class SupportSpawnAbility extends Ability{
    ...
    public void addStats(Table t){
        ...
        t.row();
        t.add(Core.bundle.format("stat.wh-cooldown", Strings.autoFixed(reload / 60f, 2)));
        t.row();
        t.add(Core.bundle.format("stat.wh-range", Strings.autoFixed(spawnRange / tilesize, 2)));
        t.row();
        t.add(Core.bundle.format("stat.wh-support-spawn-count", spawnCount));
        t.row();
