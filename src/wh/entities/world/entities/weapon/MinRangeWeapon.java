...
public class MinRangeWeapon extends Weapon{
    public float minRange = 100;

    public MinRangeWeapon(String name){
        super(name);
    }
    ...
    public void update(Unit unit, WeaponMount mount){
        ...
        /*  if(!controllable && autoTarget)*/
        {
            ...
            if(mount.target != null){
                ...
                boolean inMinRange = targetDistance <= minRange;

                boolean inRange = targetDistance <= bullet.range + (mount.target instanceof Sized s ? s.hitSize() / 2f : 0f);

                shoot = !inMinRange && inRange && can;
