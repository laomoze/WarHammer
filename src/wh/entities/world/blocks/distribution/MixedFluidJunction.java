...
public class MixedFluidJunction extends LiquidJunction{
    public float speed = 30; //frames taken to go through this junction
    public int capacity = 15;
    public float displayedSpeed = 13f;

    public MixedFluidJunction(String name){
        super(name);
        update = true;
    }
    ...
    public class MixedFluidJunctionBuild extends LiquidJunctionBuild{
