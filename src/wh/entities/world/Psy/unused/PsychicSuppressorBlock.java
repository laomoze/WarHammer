...
public class PsychicSuppressorBlock extends PsychicFieldMachineBlock {
    ...
    public class PsychicSuppressorBuild extends PsychicFieldMachineBuild {
        ...
        public void draw() {
            ...
            Draw.z(Layer.effect);
            Draw.color(WHPal.PsyColor, Color.white, 0.08f + warmup * 0.08f);
            ...
            if (field > 0.001f || warmup > 0.001f) {
                Drawf.light(x, y, radius * 2.3f, WHPal.PsyColor, 0.16f + field * 0.18f + warmup * 0.12f);
            }
        }
        ...
        public void buildConfiguration(Table table) {
            table.table(Styles.black6, t -> {
                ...
                t.add(block.localizedName).color(WHPal.PsyColor).row();
