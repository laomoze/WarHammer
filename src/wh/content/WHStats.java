...
public class WHStats{
    ...
    heatReduceMax=new Stat("wh-heat-reduce-max"),
            ...
            psychicLinkReceive = new Stat("wh-psychic-link-receive", StatCat.function),
            psychicLinkOutput = new Stat("wh-psychic-link-output", StatCat.function),
            psychicHarvestRule = new Stat("wh-psychic-harvest-rule", StatCat.function),
